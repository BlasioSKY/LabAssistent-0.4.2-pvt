...
// @require      https://raw.githubusercontent.com/BlasioSKY/LabAssistent-0.4.2-pvt/main/anchor-browserified.js
// @require      https://raw.githubusercontent.com/BlasioSKY/LabAssistent-0.4.2-pvt/main/buffer-browserified.js
// @require      https://raw.githubusercontent.com/BlasioSKY/LabAssistent-0.4.2-pvt/main/bs58-browserified.js
...
(async function() {
    ...
    let rpcEndpoints = ['https://solana-mainnet.g.alchemy.com/v2/_rWXOoGgqpMcTsfIY3waTNc0qyVM4LDd','https://rpc.hellomoon.io/55e58be7-ab31-42db-8611-893955fc15d0'];
    ...
    async function handleScan(i, fleetCoords, destCoords) {
        ...
        if (readyToScan) {
            ...
            if (Date.now() > userFleets[i].scanEnd) {
                ...
                let strike = scanCondition < userFleets[i].scanMin && (Date.now() - userFleets[i].scanSectorStart) >= 180000 ? true : false;
